...
The structural interpretation follows from the price-impact decomposition in \cref{rem:price-impact} (Section~\ref{sec:theory}):
...
Section~\ref{sec:theory}), though as noted there it is a maintained empirical
