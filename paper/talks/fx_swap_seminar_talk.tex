...
\begin{frame}{Proposition 3: The Premium Is Convex in Tightness}
...
\begin{frame}{Instrument Validity: Two Conditions}
  ...
  \begin{enumerate}
    ...
    \begin{itemize}
      ...
      \item First stage KP $F$-statistic $\gg 10$ (Table~1)
...
\begin{frame}{First Stage: Strong Instrument}
  ...
  \begin{tabular}{lcc}
    ...
    & (1) Baseline & (2) + CDS \\
    \midrule
    $Z_{m,t}^{MMF}$ & \textbf{positive***} & \textbf{positive***} \\
    \midrule
    Market FE & Yes & Yes \\
    Time FE & Yes & Yes \\
    KP $F$-stat & \multicolumn{2}{c}{$\gg 10$ (Table~1)} \\
    \bottomrule
  \end{tabular}
  \end{center}
